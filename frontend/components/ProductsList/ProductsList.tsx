...
const ProductsList = () => {
  return (
    <div className="container mx-auto px-4 py-12 ">
      ...
      <p className="text-center  mb-10 max-w-2xl mx-auto">Discover our premium selection of high-quality products designed for your needs.</p>
      
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {products.map((product) => (
          <Card key={product.id} className="rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300 border-0">
            ...
            <CardContent>
              <CardDescription className="text-sm mb-4 text-gray-600 line-clamp-2">
                {product.description}
              </CardDescription>
